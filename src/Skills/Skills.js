              ...
              <>
                ...
                <div className="knowOuter">
                  ...
                  <div
                    className="knowInner"
                    style={{
                      background: `linear-gradient(to right,rgb(45, 223, 22) ${
                        display.knowledge
                      }%,white ${display.knowledge + 40}%)`,
                    }}
                  ></div>
                </div>
                {/* Favourite Topics */}
                ...
                <div className="favourites">
                  ...
                  <p>
                    <big>{display.experience}</big> Months
                  </p>
                </div>
                <div className="skillInfo">
                  <h3>NOTE</h3>
                  <h5>--The above info are subject to Increase!!!</h5>
                </div>
              </>
            ) : (
              ""
