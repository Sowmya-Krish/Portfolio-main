  ...
  return (
    <div className="App" onKeyUp={handleNavigate}>
      ...
      <Routes>
        ...
        <Route
          path="/Experience"
          element={<Experience style={style} setStyle={setStyle} />}
        />
        <Route
          path="/Skills"
          element={<Skills style={style} setStyle={setStyle} />}
        />
        <Route
          path="/Projects"
          element={<Projects style={style} setStyle={setStyle} />}
        />
        <Route
          path="/Contact-me"
          element={<ContactMe style={style} setStyle={setStyle} />}
        />
