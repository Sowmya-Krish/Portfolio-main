...
function ContactMe({ style, setStyle }) {
  ...
  const [newPersonReachOut, setNewPersonReachOut] = useState({
    name: "",
    email: "",
    message: "",
  });
        ...
        <div className="grids">
          <div className="contactInfo">
            ...
            <div className="contactLinks">
              ...
              <button>
                <a
                  href="https://github.com/Sowmya-Krish"
                  rel="noreferrer"
                  target="_blank"
                  title="Github/Sowmya-Krish"
                >
                  🤹‍♂️ Github
                </a>
              </button>
            ...
            <div className="contactLinks">
              <button>
                <a
                  href="https://drive.google.com/file/d/1HkyN5MnaXXudmJVfrk3tgPpI3GRWIYgQ/view"
                  rel="noreferrer"
                  target="_blank"
                  title="Resume"
                >
            ...
            {window.innerWidth <= 900 ? (
              <>
                <h1 className="headingMe">
                  <span>{"<"}</span>For more Enquiries<span>{"/>"}</span>
                </h1>
                <div className="contactLinks">
